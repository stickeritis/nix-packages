...
rec {
  ...
  workspaceMembers = {
    "sticker" = {
      packageId = "sticker 0.6.1 (path+file:///home/daniel/git/sticker/sticker)";
    ...
    "sticker-tf-proto" = {
      packageId = "sticker-tf-proto 0.6.0 (path+file:///home/daniel/git/sticker/sticker-tf-proto)";
      build = buildRustCrateWithFeatures {
        packageId = "sticker-tf-proto 0.6.0 (path+file:///home/daniel/git/sticker/sticker-tf-proto)";
        features = rootFeatures;
      };
    ...
    "sticker-utils" = {
      packageId = "sticker-utils 0.6.1 (path+file:///home/daniel/git/sticker/sticker-utils)";
      build = buildRustCrateWithFeatures {
        packageId = "sticker-utils 0.6.1 (path+file:///home/daniel/git/sticker/sticker-utils)";
        features = rootFeatures;
      };
  ...
  crates = {
    ...
    "backtrace-sys 0.1.31 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        buildDependencies = {
          "cc" = "cc 1.0.40 (registry+https://github.com/rust-lang/crates.io-index)";
        };
        features = {
    ...
    "console 0.7.7 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          ...
          "regex" = "regex 1.2.1 (registry+https://github.com/rust-lang/crates.io-index)";
          "termios" = {
    ...
    "quote 1.0.1 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          "proc-macro2" = {
            packageId = "proc-macro2 1.0.1 (registry+https://github.com/rust-lang/crates.io-index)";
            usesDefaultFeatures = false;
          };
        };
        features = {
    ...
    "regex 1.2.1 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          "aho-corasick" = "aho-corasick 0.7.6 (registry+https://github.com/rust-lang/crates.io-index)";
          "memchr" = "memchr 2.2.1 (registry+https://github.com/rust-lang/crates.io-index)";
          "regex-syntax" = "regex-syntax 0.6.11 (registry+https://github.com/rust-lang/crates.io-index)";
    ...
    "serde_derive 1.0.99 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          "proc-macro2" = "proc-macro2 1.0.1 (registry+https://github.com/rust-lang/crates.io-index)";
          "quote" = "quote 1.0.1 (registry+https://github.com/rust-lang/crates.io-index)";
          "syn" = {
            packageId = "syn 1.0.2 (registry+https://github.com/rust-lang/crates.io-index)";
            features = [ "visit" ];
          };
        };
        features = {
    ...
    "sticker 0.6.1 (path+file:///home/daniel/git/sticker/sticker)"
      = rec {
        crateName = "sticker";
        version = "0.6.1";
        edition = "2018";
        ...
        dependencies = {
          ...
          "serde_derive" = "serde_derive 1.0.99 (registry+https://github.com/rust-lang/crates.io-index)";
          "sticker-tf-proto" = "sticker-tf-proto 0.6.0 (path+file:///home/daniel/git/sticker/sticker-tf-proto)";
          "tensorflow" = "tensorflow 0.13.0 (registry+https://github.com/rust-lang/crates.io-index)";
        };
        features = {
        };
      };
    "sticker-tf-proto 0.6.0 (path+file:///home/daniel/git/sticker/sticker-tf-proto)"
      = rec {
    ...
    "sticker-utils 0.6.1 (path+file:///home/daniel/git/sticker/sticker-utils)"
      = rec {
        ...
        dependencies = {
          ...
          "sticker" = "sticker 0.6.1 (path+file:///home/daniel/git/sticker/sticker)";
          "tensorflow" = "tensorflow 0.13.0 (registry+https://github.com/rust-lang/crates.io-index)";
    ...
    "syn 1.0.2 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        dependencies = {
          ...
          "quote" = {
            packageId = "quote 1.0.1 (registry+https://github.com/rust-lang/crates.io-index)";
            optional = true;
            usesDefaultFeatures = false;
          };
          "unicode-xid" = "unicode-xid 0.2.0 (registry+https://github.com/rust-lang/crates.io-index)";
    ...
    "winapi 0.3.7 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "lmcons" "memoryapi" "minschannel" "minwinbase" "minwindef" "ntsecapi" "ntstatus" "processenv" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincon" "wincrypt" "winerror" "winnt" "winsock2" "winuser" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
